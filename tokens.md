...
| $FE $2E | SCREEN | ⚠️ | all forms: [s,]w,h,d, CLR c, DEF, OPEN [s], SET d,v (attic-backed double buffering), CLOSE [s]; every screen renders 320x200x256 FCM (VIC-IV, not bitplanes) |
